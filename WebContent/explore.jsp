...
<title>Sage - Explore Policies</title>
	...
	<div class="content">
		...
		<div class="row container-fluid">
			...
			<p id="dash-info" class="text-center"
				...
				<b>Welcome to our catalogue, ${Customer.name}</b> <br>Choose
				from our comprehensive policies to ensure minimum hassles during
			...
			<div class="text-center col-md">
				...
				<form action="quote1.ins" method="post">
					...
					<input type="text" name="registerNo"
						...
						title="Enter a valid registration number" required> <br>
					<br> <br>
					<h3>Choose a Policy:</h3>
					<div class="form-group text-center"
						style="margin-left: 40%; width: 40%;">
						<select class="form-control text-center" id="ptype" required
							name="policyType">
